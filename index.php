...
?>
  ...
  <div id="row">
    <div id="content" align="left">
      <h1><img src="<?php echo $icon;?>.png" width="60" height="60" alt=""/><?php echo $title; ?></h1>
      ...
      <p class="center">
        ...
        <a class="download-link" href="<?php echo $museumLink; ?>">
          <img src="<?php echo $PROTOCOL . "://www.webosarchive.org/app-template/"?>museum-badge.png" width="200" height="59" alt="Get it in the App Museum" />
        </a>
        <?php } ?>
      </p>
    </div>
